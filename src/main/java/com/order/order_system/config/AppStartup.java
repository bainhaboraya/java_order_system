...
public void addUserDemoData() {
    if (userService.findAll().isEmpty()) {
        userService.insert(new AppUser("Bainh", "Alaa", "mali", "123" ,"bainh@gmail.com", Arrays.asList(roleService.findByName("Admin"))));
        userService.insert(new AppUser("esraa", "Alaa", "mali", "123" ,"esraa@gmail.com", Arrays.asList(roleService.findByName("User"))));
